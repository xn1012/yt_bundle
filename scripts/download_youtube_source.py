...
def choose_subtitle_languages(metadata: dict, preferred: list[str]) -> list[str]:
    ...
    for family in family_order:
        matcher = is_english_lang if family == "en" else is_chinese_lang
        candidate = pick_preferred_language(preferred, manual, automatic, matcher)
